  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-transparent">
      ...
      <div className="relative z-10 text-black pointer-events-none">
        ...
        <div className="grid place-items-start grid-cols-1 md:grid-cols-2 gap-8 w-full px-6 md:px-20">
        ...
        <main className="relative pt-20 bg-white">
          <section id="experience" className="min-h-screen place-items-start ml-0">
            <div className="mx-auto max-w-screen-lg">
              ...
              >
                <div className="flex flex-col md:flex-row place-items-center mb-10">
                  <h2 className="text-4xl mb-2 md:text-6xl tracking-wide mr-4 font-bold text-blue-500">
                    WORK
                  </h2>
                  <h2
                    className="text-4xl mb-2 md:text-6xl tracking-wide font-bold"
                    style={{
                      color: 'transparent',
                  ...
                  <p className="w-100 md:flex-1 border-t-2 border-gray-400 mt-4 md:mt-5 md:ml-6"></p>
                </div>

                <div className="px-5 md:px-0">
                  <div className="bg-blue-950 place-items-center rounded-2xl p-8 mb-10 flex flex-col md:flex-row md:items-start gap-6 relative">
                    <span className="text-5xl font-bold text-blue-500 leading-none">01</span>
                  ...
                  <div className="bg-blue-950 rounded-2xl p-8 mb-10 flex flex-col md:flex-row md:items-start gap-6 relative">
                    <span className="text-5xl font-bold text-blue-500 leading-none">02</span>
                    <div className="flex-1">
                      <div className="flex flex-col md:flex-row md:items-baseline md:justify-between gap-2 mb-3">
                        <div className="flex flex-col md:flex-row md:items-baseline gap-1 md:gap-3">
                          <h3 className="text-2xl font-bold text-white">
          ...
          <section id="project" className="min-h-screen" data-bgcolor="#ffd700" data-textcolor="#ffffff">
            <div className="md:container md:mx-auto px-2 md:px-4">
              <motion.div initial={{ opacity: 0, scale: 0.8 }}
                ...
                <div className="flex flex-col md:flex-row place-items-center md:place-items-start mt-20">
                  <h2 className="text-4xl mb-2 md:text-6xl tracking-wide mr-4 font-bold text-blue-500">
                    A FEW THINGS 
                  </h2>
                  <h2
              ...
              <motion.div
                ...
                <div className="py-10 pointer-events-auto">
                  <div className="container mt-10 flex flex-col md:flex-row md:relative">
                    ...
                    <div className="z-20 md:mt-20 mt-10 flex flex-col-reverse md:flex-row w-fullplace-items-center md:w-[500px] md:h-[250px] p-6 bg-gray-400 shadow-xl rounded-md"> 
                      <p className="font-normal text-sm text-white">
