              ...
              <motion.div
                ...
                <div className="py-10 pointer-events-auto">
                  <div className="container mt-10 flex flex-col md:flex-row md:relative">
                    ...
                    <div className="z-20 md:mt-30 mt-10 flex flex-col-reverse md:flex-row w-fullplace-items-center md:w-[500px] md:h-[250px] p-6 bg-gray-400 shadow-xl rounded-md"> 
                      <p className="font-normal text-sm text-white">
