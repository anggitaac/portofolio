    ...
    <div className="relative min-h-screen overflow-hidden bg-[#FFF9F2]">
      ...
      <div className="relative z-10 text-black pointer-events-none">
        ...
        <main className="md:py-10 relative z-10 flex flex-col items-center justify-center min-h-screen bg-transparent">
          <section id="about" className="flex flex-col items-center justify-center w-full h-full py-10"> 
            <div className="grid place-items-center grid-cols-1 md:grid-cols-12 gap-8 w-full px-6 md:px-20">
              ...
              <div className="col-span-1 md:col-span-5 -mt-10 md:ml-15 justify-end">
                ...
                >
                  <div className="w-full max-w-2xl mx-auto border-2 border-[#800020] bg-[#FFF9F2] rounded-3xl p-4 shadow-md">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
                      <div className="p-1 rounded-2xl bg-[#D45060] text-amber-50 shrink-0 self-center sm:self-auto">
                        <FaGraduationCap className="w-5 h-5 md:h-8 md:w-8 " />
                      </div>
            ...
            <div className="px-10 md:px-20">
              ...
              >
                <div className="mb-10 text-left">
                  <h2 className="text-2xl mb-2 md:text-4xl mr-4 font-bold text-[#800020]">
                    Experience
                  </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <><div className="col-span-1 bg-[#FFF9F2] rounded-2xl p-8 flex flex-col md:flex-row md:items-start gap-6 relative">
                    <span className="text-4xl font-bold text-[#800020] leading-none">01</span>
                    <div className="flex-1">
                      ...
                      <img src="/img/PT Alfatih Pilar Peradaban.jpg" alt="PT Alfatih Pilar Peradaban" className="rounded-lg shadow-lg w-full sm:w-40" />
                    </div>
                  </div><div className="col-span-1 bg-[#FFF9F2] rounded-2xl p-8 flex flex-col md:flex-row md:items-start gap-6 relative">
                      <span className="text-4xl font-bold text-[#800020] leading-none">02</span>
                      <div className="flex-1">
                        <div className="flex flex-col md:flex-row md:items-baseline md:justify-between gap-2 mb-3">
                        ...
                        <div className="flex flex-wrap gap-6 mt-4">
                          <img src="/img/BPJS Ketenagakerjaan.jpg" alt="BPJS Ketenagakerjaan" className="rounded-lg shadow-lg w-full sm:w-40" />
                          <img src="/img/Sertifikat Apre Magang Berdampak 2025.jpg" alt="Sertifikat Apresiasi Magang Berdampak 2025" className="rounded-lg shadow-lg w-full sm:w-40" />
                        </div>
                      </div>
                    </div></>
                  )}
                  ...
                  <div className="col-span-1 bg-[#FFF9F2] rounded-2xl p-8 flex flex-col md:flex-row md:items-start gap-6 relative">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex flex-wrap gap-6 mt-4">
                        <img src="/img/SERTIFIKAT HIMPUNAN MAHASISWA DEWAN PERWAKILAN HIMATASKA 2024-2025 copy_page-0004.jpg" alt="HIMATASKA" className="rounded-lg shadow-lg w-full sm:w-40" />
                        <img src="/img/DP.jpeg" alt="HIMATASKA" className="rounded-lg shadow-lg w-full sm:w-40" />
                      </div>
                    </div>
                  </div>
                  <div className="col-span-1 bg-[#FFF9F2] rounded-2xl p-8 flex flex-col md:flex-row md:items-start gap-6 relative">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex flex-wrap gap-6 mt-4">
                        <img src="/img/Sertifikat Anggota HIMATASKA EKOBIS.jpg" alt="HIMATASKA EKOBIS" className="rounded-lg shadow-lg w-full sm:w-40" />
                        <img src="/img/EKOBIS.jpeg" alt="HIMATASKA EKOBIS" className="rounded-lg shadow-lg w-full sm:w-40" />
                      </div>
                    </div>
                  </div>
                  </>
          ...
          <section id="project" className="py-20 w-full">
            <div className="w-full px-6 md:px-20">
              <motion.div initial={{ opacity: 0, scale: 0.8 }}
                ...
                <div className="py-5 md:py-10 text-center animate-pulse">
                  <h1 className="text-lg font-bold text-gray-500/40 font-serif mb-2 md:text-2xl tracking-wide mr-4">
                    A FEW THINGS
                  </h1>
                  <h2 className="text-2xl mt-[-25] mb-2 md:text-5xl font-serif  tracking-wide mr-4 font-bold text-[#800020]/80">
                    I&#39;VE BUILT
                  </h2>
                </div>
              </motion.div>
                ...
                <div className="md:py-10 pointer-events-auto duration-300 ease-in-out max-w-full md:ml-10">
                  <div className="container flex flex-col md:flex-row md:relative mr-10">
                    <a href="https://kabl.sik-upi.com/" className="place-items-center z-30 md:absolute w-full md:place-items-start md:w-[400px] md:h-[100px]">
                      ...
                      <h5 className="mt-2 md:mt-5 text-xl md:text-2xl font-bold tracking-tight text-gray-900">
                        Konservasi Alam Bawah Laut Sukarame
                      </h5>
                    </a>
                    <div className="z-20 md:mt-30 mt-10 flex flex-col-reverse md:flex-row w-fullplace-items-center md:w-[700px] md:h-[200px] p-6 bg-gray-400 shadow-xl rounded-md"> 
                    ...
                    <a href="https://drive.google.com/drive/folders/1ifhBce4fnHjUmnlAsfOHOO_oaTamCp93?usp=sharing" className="z-10 md:ml-[-100px] order-1 md:order-2">
                      <Image width={500} height={500} src="/img/project1.png" className="md:h-110 md:w-300 w-full rounded-lg" alt="kabl" />
                    </a>
                  </div>
                </div>
              </motion.div>
                ...
                <div className="md:py-10 pointer-events-auto max-w-full md:ml-10">
                  <div className="container mt-10 flex flex-col md:flex-row md:relative">
                    <a href="https://fishzonemapper.sik-upi.com/" className="place-items-center z-30 md:absolute w-full md:place-items-start md:w-[400px] md:h-[100px]">
                      ...
                      <h5 className="mt-2 md:mt-5 text-2xl md:text-2xl font-bold tracking-tight text-gray-900">
                        FishZone Mapper
                      </h5>
                    </a>
                    <div className="z-20 md:mt-30 mt-10 flex flex-col-reverse md:flex-row w-fullplace-items-center md:w-[700px] md:h-[210px] p-6 bg-gray-400 shadow-xl rounded-md"> 
                      <p className="font-normal text-xs md:text-sm text-white">
                    ...
                    <a href="https://drive.google.com/drive/folders/1SAe8Qr5lHiCMK4769KMKovpdqEFKHQNE?usp=sharing" className="z-10 md:ml-[-100px] order-1 md:order-2">
                      <Image width={500} height={500} src="/img/project2.png" className="md:h-110 md:w-300 w-full rounded-lg" alt="fishzonemapper" />
                    </a>
                  </div>
                </div>
              </motion.div>
              <motion.div
                ...
                <div className="md:py-10 pointer-events-auto max-w-full md:ml-10">
                  <div className="container mt-10 flex flex-col md:flex-row md:relative">
                    ...
                    <div className="z-20 md:mt-30 mt-5 w-full block md:w-[700px] md:h-[230px] p-6 bg-gray-400 shadow-xl rounded-md">
                    ...
                    <a href="https://drive.google.com/file/d/1RG0xdgEj8nyN8h6c0irPX9RofiJXVa_e/view?usp=sharing" className="z-10 md:ml-[-100px] order-1 md:order-2">
                      <Image width={500} height={500} src="/img/project3.png" className="md:h-110 md:w-300 w-full rounded-lg" alt="APP" />
                    </a>
                  </div>
                </div>
              </motion.div>
              <motion.div
                ...
                <div className="md:py-10 pointer-events-auto max-w-full md:ml-10">
                  <div className="container mt-10 flex flex-col md:flex-row md:relative">
                    ...
                    <div className="z-20 md:mt-30 mt-10 flex flex-col-reverse md:flex-row w-fullplace-items-center md:w-[700px] md:h-[250px] p-6 bg-gray-400 shadow-xl rounded-md"> 
                      <p className="font-normal text-xs md:text-sm text-white">
                    ...
                    <a href="#" className="z-10 md:ml-[-100px] order-1 md:order-2">
                      <Image width={500} height={500} src="/img/project4.png" className="md:h-110 md:w-300 w-full rounded-lg" alt="cekin" />
                    </a>
                  </div>
                </div>
              </motion.div>
          ...
          <section id="publications" className="py-10 px-4 md:px-20 grid grid-cols-1 md:grid-cols-3 gap-4 ">
            <div className="col-span-1 md:ml-10 flex place-items-center md:place-items-start">
              ...
              initial={{ opacity: 0, scale: 0.8 }}
                ...
                >
              <h2 className="text-lg md:text-2xl mb-2">Scientific</h2>
              <h2 className="text-3xl md:text-5xl font-bold mb-8 text-[#D45060]">Publications</h2>
              </motion.div>
              <p className="hidden md:block flex-1 mr-10 border-r border-black"></p>
            </div>
            <div className="col-span-2">
              <ul className="space-y-6 md:ml-10 md:mr-5 pointer-events-auto">
                {publications.map((pub, index) => (
                  ...
                  >
                    <a
                      href={pub.url}
                      className="text-lg md:text-xl text-gray-700 hover:underline"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      {pub.title}
                    </a>
                    <p className="text-sm md:text-lg text-gray-500">{pub.journal}</p>
          ...
          <motion.div
              initial={{ opacity: 0, scale: 0.8 }}
                ...
                >
          <section id="contactme" className="bg-[#800020] pointer-events-auto rounded-t-full">
            <div className="md:py-40 py-20 px-20 md:px-80 items-center text-center">
              <h1 className="text-xl md:text-2xl text-amber-50 font-bold">Get in touch</h1>
              <h1 className="mt-10 text-3xl md:mt-20 md:text-5xl text-white font-serif font-bold">Let&#39;s Work Together</h1>
              ...
              <div className="mt-12 md:mt-20 flex justify-center">
                <button className="text-white bg-gradient-to-r from-red-300 via-red-400 to-red-500 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-200 dark:focus:ring-pink-800 shadow-lg shadow-red-500/50 dark:shadow-lg dark:shadow-red-800/80 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2">
                  <a href="mailto:anggitaac33@gmail.com" className="text-white md:text-lg">Say HI!</a>
                </button>
              </div>
            </div>
          </section>
